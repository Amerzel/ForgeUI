      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <Toolbar aria-label="Editor toolbar">
          ...
          <Toolbar.ToggleGroup
            ...
            value={activeTool}
            onValueChange={(v) => {
              if (v) setActiveTool(v)
            }}
          >
            <Toolbar.ToggleItem value="select" aria-label="Select">
              ✦ Select
            </Toolbar.ToggleItem>
            <Toolbar.ToggleItem value="move" aria-label="Move">
              ✥ Move
            </Toolbar.ToggleItem>
            <Toolbar.ToggleItem value="rotate" aria-label="Rotate">
              ↻ Rotate
            </Toolbar.ToggleItem>
            <Toolbar.ToggleItem value="scale" aria-label="Scale">
              ⤡ Scale
            </Toolbar.ToggleItem>
          </Toolbar.ToggleGroup>
        </Toolbar>
