...
const meta: Meta<typeof ModuleToolbar> = {
  ...
  tags: ['autodocs'],
  parameters: {
    docs: { description: { component: 'Module header toolbar with badge, title, content slot, and actions slot.' } },
  },
}
export default meta
  ...
  args: {
    ...
    children: (
      <div style={{ display: 'flex', gap: '4px' }}>
        ...
        <Button variant="ghost" size="sm">🗂 Tree</Button>
      </div>
    ),
    actions: (
