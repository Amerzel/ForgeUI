...
const MOCK_MANIFEST = {
  ...
  tiles: [
    ...
    {
      id: 'grass_water_ms6_cliff-shadow',
      case: 6,
      pair: 'grass_water',
      effect: 'cliff-shadow',
      layer: 'effects',
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: 'var(--forge-space-4)', overflow: 'auto' }}>
        ...
        >
          {selectedNode?.startsWith('gw-')
            ? 'grass → water / ' + selectedNode.replace('gw-', '')
            : 'All Tiles (258)'}
        </Text>
          ...
          {Array.from({ length: 14 }, (_, i) => (
            <div
              ...
              style={{
                ...
                height: 64,
                backgroundColor:
                  (i === 5 || i === 10) && selectedNode?.includes('cliff-shadow')
      ...
      >
        {splitView === 'split' ? (
          ...
          <PlaceholderCanvas
            label={
              splitView === 'mask'
                ? 'SDF Mask (blue → red gradient)'
                : splitView === 'effect'
                  ? 'Effect Overlay (alpha channel)'
                  : 'Fill + Mask + Effect'
            }
          />
        )}
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        <div style={{ flex: 1 }} />
        <DropZone accept={['.png']} multiple onDrop={() => {}} className="forge-inline-drop">
          <Text size="xs" color="muted">
            + Drop fills to compare
          </Text>
        </DropZone>
      </div>
      ...
      <Stack gap={3} style={{ padding: 'var(--forge-space-3)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '4px 12px' }}>
          ...
          <Text size="xs" style={{ fontFamily: 'var(--forge-font-mono)', wordBreak: 'break-all' }}>
            {selectedNode === 'gap-1'
              ? 'grass_water_ms5_cliff-shadow'
              : 'grass_water_ms10_cliff-shadow'}
          </Text>
          <Text size="xs" color="muted">
            Pair
          </Text>
    ...
    <Stack gap={3} style={{ padding: 'var(--forge-space-3)' }}>
      ...
      <div
        style={{
          ...
          alignSelf: 'center',
          backgroundColor:
            'color-mix(in srgb, var(--forge-accent) 12%, var(--forge-surface-sunken))',
          border: '1px solid var(--forge-border)',
          borderRadius: 'var(--forge-radius-lg)',
          display: 'flex',
          alignItems: 'center',
      ...
      {/* Corner bit diagram */}
      <Text size="xs" color="muted" style={{ display: 'block' }}>
        Corner Bits (MS-3)
      </Text>
      <div
        style={{
...
function PaintProperties() {
  return (
    <Stack gap={3} style={{ padding: 'var(--forge-space-3)' }}>
      <Text size="xs" color="muted" style={{ textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        Cell (4, 7)
      </Text>
      <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '4px 12px' }}>
        <Text size="xs" color="muted">
      ...
      <Stack gap={1}>
        {[
          'terrain: grass',
          'transition: grass_water_ms6',
          'outline: grass_water_ms6_outline',
          'cliff-face: grass_water_ms6_cliff-face',
        ].map((l) => (
          <Text
            key={l}
            size="xs"
            style={{ fontFamily: 'var(--forge-font-mono)', color: 'var(--forge-text-muted)' }}
          >
            {l}
          </Text>
        ))}
          ...
          <Flex key={m.name} align="center" gap={2}>
            <div
              style={{
                ...
                height: 16,
                borderRadius: 'var(--forge-radius-sm)',
                backgroundColor: `var(--forge-${m.color})`,
                opacity: 0.6,
              }}
            />
  ...
  return (
    <ScrollArea style={{ height: '100%' }}>
      <Stack gap={3} style={{ padding: 'var(--forge-space-3)' }}>
          ...
          <Card.Body>
            <Flex align="center" justify="between">
              <Stack gap={1}>
                ...
                <Text size="2xl" weight="bold" style={{ color: 'var(--forge-success)' }}>
                  4.2
                </Text>
              </Stack>
            ...
            <Text
              size="xs"
              color="muted"
              style={{ marginTop: 'var(--forge-space-2)', display: 'block' }}
            >
        ...
        <div
          style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--forge-space-2)' }}
        >
          <Card>
            <Card.Body>
              <Text size="xs" color="muted">
        ...
        <Stack gap={1}>
          ...
          <Text size="xs">
            Painterly at 64px with antiAlias=true. RMSE 4.2 is well within threshold. Noise
            amplitude 3–5 recommended.
          </Text>
        </Stack>
      </Stack>
    </ScrollArea>
...
Click the mode buttons in the bottom-left to switch focus. Click tree nodes in the left browser to navigate. The right properties panel adapts to the current mode and selection.`,
  ...
  render: function UnifiedWorkspaceDemo() {
    ...
    const [packFile, setPackFile] = useState<FileSourceBarFile | null>({
      name: 'terrain_pack.v1.png',
      size: 2097152,
      type: 'image/png',
    })
        ...
        >
          ...
          >
            <FileSourceBar
              file={packFile}
              onLoad={() =>
                setPackFile({ name: 'terrain_pack.v1.png', size: 2097152, type: 'image/png' })
              }
...
export const TileInspector: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Module 1: Load a terrain_pack.v1 atlas and browse tiles by layer, boundary pair, and MS case. Click a tile to see its metadata.',
      },
    },
  },
        ...
        >
          ...
          <ModuleToolbar badge="TI" title="Tile Inspector">
            <FileSourceBar
              file={file}
              onLoad={() =>
                setFile({ name: 'terrain_pack.v1.png', size: 2097152, type: 'image/png' })
              }
              onClear={() => {
                setFile(null)
                  ...
                  <ScrollArea style={{ flex: 1 }}>
                    <div style={{ padding: 'var(--forge-space-4)' }}>
                      <Text
                        size="xs"
                        color="muted"
                        style={{ marginBottom: 'var(--forge-space-2)', display: 'block' }}
                      >
                        TRANSITIONS — grass → water (14 cases × 3 effects)
                      </Text>
                      <div
                        style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--forge-space-2)' }}
                      >
                        {Array.from({ length: 14 }, (_, i) => (
                          <div
                            key={i}
                            role="button"
                            tabIndex={0}
                            onClick={() => setSelectedTile(`grass_water_ms${i}_transition`)}
                            onKeyDown={(e) => {
                              if (e.key === 'Enter' || e.key === ' ')
                                setSelectedTile(`grass_water_ms${i}_transition`)
                            }}
                            style={{ cursor: 'pointer' }}
                          >
                            <TilePlaceholder
                              id={`ms${i}`}
                              color={selectedTile?.includes(`ms${i}`) ? 'accent' : 'info'}
                            />
                          </div>
                        ))}
                      </div>
                      ...
                      >
                        {Array.from({ length: 14 }, (_, i) => (
                          <div
                            ...
                            role="button"
                            tabIndex={0}
                            onClick={() => setSelectedTile(`grass_water_ms${i}_cliff-face`)}
                            onKeyDown={(e) => {
                              if (e.key === 'Enter' || e.key === ' ')
                                setSelectedTile(`grass_water_ms${i}_cliff-face`)
                            }}
                          >
                            <TilePlaceholder
                              id={`ms${i}`}
                              color={i === 5 || i === 10 ? 'danger' : 'success'}
                            />
                          </div>
                        ))}
                      </div>
                      <div style={{ marginTop: 'var(--forge-space-1)' }}>
                        <Text size="xs" style={{ color: 'var(--forge-danger)' }}>
                          ⚠ 2 missing effect tiles (ms5, ms10)
                        </Text>
                      </div>
                    </div>
                  </ScrollArea>
...
export const EffectWorkbench: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Module 3: Tune effect parameters with instant visual feedback. Sliders drive real-time re-renders of SDF masks and effect overlays.',
      },
    },
  },
                ...
                >
                  ...
                  <div>
                        ...
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor: [1, 3, 5, 7, 9, 11, 13].includes(i)
                              ? 'color-mix(in srgb, var(--forge-success) 15%, var(--forge-surface))'
                              : 'color-mix(in srgb, var(--forge-danger) 10%, var(--forge-surface))',
                            color: [1, 3, 5, 7, 9, 11, 13].includes(i)
                              ? 'var(--forge-success)'
                              : 'var(--forge-danger)',
                            borderRadius: 'var(--forge-radius-sm)',
                          }}
                    ...
                    <Text
                      size="xs"
                      color="muted"
                      style={{ marginTop: 'var(--forge-space-1)', display: 'block' }}
                    >
...
export const MapPainter: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Module 2: Paint materials onto a grid and see the resolved tile map update live with marching-squares classification.',
      },
    },
  },
            ...
            <ResizablePanel defaultSize={20} minSize={16} maxSize={30}>
              <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <Stack gap={1}>
                    {materials.map((m) => (
                      <div
                        ...
                        onKeyDown={(e) => {
                          if (e.key === 'Enter' || e.key === ' ') setActiveMaterial(m)
                        }}
                        style={{
                          display: 'flex',
                          alignItems: 'center',
                          ...
                          cursor: 'pointer',
                          backgroundColor:
                            activeMaterial === m ? 'var(--forge-surface-hover)' : 'transparent',
                          border:
                            activeMaterial === m
                ...
                <div style={{ padding: 'var(--forge-space-3)' }}>
                  ...
                  <Stack gap={1}>
                    {['Terrain Fills', 'Transitions', 'Outline', 'Cliff Face', 'Cliff Shadow'].map(
                      (layer) => (
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      size="xs"
                      style={{ fontFamily: 'var(--forge-font-mono)', wordBreak: 'break-all' }}
                    >
                      grass_water_ms6
                    </Text>
                  </div>
...
export const FillInspector: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Module 4: Preview and debug fill texture tiling quality with seam heat maps and RMSE scoring.',
      },
    },
  },
                ...
                <Tabs
                  ...
                  items={[
                        ...
                        <Stack gap={4} style={{ padding: 'var(--forge-space-4)' }}>
                          ...
                          <div>
                            <Text
                              size="xs"
                              color="muted"
                              style={{ display: 'block', marginBottom: 'var(--forge-space-1)' }}
                            >
                              Style Recommendation
                            </Text>
                            <Text size="xs">
                              Painterly at 64px with antiAlias=true. RMSE 4.2 is well within
                              threshold. Noise amplitude 3–5 recommended for transition masking.
                            </Text>
                          </div>
                        </Stack>
                      ),
                    },
                    {
                      ...
                      content: (
                        <div style={{ padding: 'var(--forge-space-4)' }}>
                          <DropZone accept={['.png']} multiple onDrop={() => {}}>
                            <Stack gap={2} style={{ alignItems: 'center' }}>
                              <Text size="sm">Drop fill candidates to compare</Text>
                              <Text size="xs" color="muted">
                                Side-by-side tiling + RMSE comparison
                              </Text>
                            </Stack>
                          </DropZone>
                        </div>
...
export const EndToEndPreview: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Module 5: Full pipeline in one view — edit recipe, compose, resolve, render, and diff. Uses CLI Bridge for backend computation.',
      },
    },
  },
