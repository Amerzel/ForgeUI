...
function TokenDisplay() {
  ...
  return (
    <div style={{ fontFamily: 'var(--forge-font-mono)', fontSize: '13px', display: 'grid', gap: '8px' }}>
      <div style={{ color: 'var(--forge-text)', background: 'var(--forge-surface)', padding: '16px', borderRadius: 'var(--forge-radius-md)', border: '1px solid var(--forge-border)' }}>
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'ThemeProvider wraps the app and provides palette/mode switching. Use the toolbar above to switch themes.',
      },
    },
  },
}
