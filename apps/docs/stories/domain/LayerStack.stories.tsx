...
const meta: Meta = {
  ...
  tags: ['autodocs'],
  parameters: {
    docs: { description: { component: 'Layer list with visibility/lock/opacity toggles, drag-to-reorder, thumbnails, and compact mode.' } },
  },
}
export default meta
type Story = StoryObj
  ...
  render: function LayerStackDemo() {
    ...
    return (
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px', maxWidth: '320px' }}>
        <Text size="sm" style={{ fontWeight: 500 }}>Scene Layers</Text>
        <LayerStack
          layers={layers}
          selectedId={selected}
...
export const Compact: Story = {
  ...
  render: function LayerStackCompact() {
    ...
    return (
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px', maxWidth: '280px' }}>
        <Text size="sm" style={{ fontWeight: 500 }}>Compact Layers</Text>
        <LayerStack
          layers={layers}
          selectedId={selected}
          onSelect={setSelected}
