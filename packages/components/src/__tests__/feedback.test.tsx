...
describe('Alert', () => {
  ...
  it('has role="alert" when live=true', () => {
    render(
      <Themed>
        <Alert live>Urgent message</Alert>
      </Themed>,
    )
  ...
  it('renders dismiss button and calls onDismiss', async () => {
    ...
    render(
      <Themed>
        <Alert title="Info" onDismiss={onDismiss}>
          Message
        </Alert>
      </Themed>,
    )
  ...
  it('has no a11y violations', async () => {
    const { container } = render(
      <Themed>
        <Alert title="File saved" variant="success">
  ...
  it('live alert has no a11y violations', async () => {
    const { container } = render(
      <Themed>
        <Alert live title="Error" variant="danger">
          Operation failed.
        </Alert>
      </Themed>,
    )
...
describe('Progress', () => {
  ...
  it('shows percentage text when showValue=true', () => {
    render(
      <Themed>
        <Progress value={42} label="Progress" showValue />
      </Themed>,
    )
  ...
  it('renders all variants without error', () => {
    ...
    for (const v of variants) {
      render(
        <Themed>
          <Progress value={50} variant={v} label={v} />
        </Themed>,
      )
    }
...
describe('EmptyState', () => {
  ...
  it('renders description when provided', () => {
    render(
      <Themed>
        <EmptyState title="Empty" description="Create one to get started." />
      </Themed>,
    )
  ...
  it('renders icon when provided', () => {
    render(
      <Themed>
        <EmptyState icon="🌍" title="No worlds" />
      </Themed>,
    )
