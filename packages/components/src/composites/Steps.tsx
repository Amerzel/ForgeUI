      ...
      {steps.map((step, i) => {
        ...
        return (
          ...
          >
            ...
            {/* Label */}
            <div
              style={{ marginTop: 'var(--forge-space-2)', textAlign: 'center', maxWidth: '100px' }}
            >
              <div
                style={{
                  fontSize: 'var(--forge-font-size-sm)',
                  fontWeight: step.status === 'active' ? 'var(--forge-font-semibold)' : undefined,
                  color: STATUS_TEXT[step.status],
                }}
              >
                {step.label}
              </div>
