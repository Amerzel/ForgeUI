...
export function ComponentIcon({ size = 20, color = 'currentColor', ...props }: IconProps) {
  return (
    ...
    >
      ...
      {/* Top tab */}
      <path d="M7 5 L7 3 Q8 2 9 3 L9 5" stroke={color} strokeWidth="1.5" strokeLinejoin="round" fill="none" />
      {/* Right socket */}
      <path d="M13 8 L15 8 Q17 9 15 11 L13 11" stroke={color} strokeWidth="1.5" strokeLinejoin="round" fill="none" />
    </svg>
  )
}
